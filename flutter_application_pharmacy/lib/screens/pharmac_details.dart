...
class _PharmacyDetailScreenState extends State<PharmacyDetailScreen> {
  ...
  List<Map<String, dynamic>> _medicines = []; // Store medicines for manual fetch
  ...
  void initState() {
    ...
    _medicinesStream = _firestore
        ...
        .snapshots();
    print('Initialized stream for pharmacyId: ${widget.pharmacyId}'); // Debug stream init
  ...
  void _showMedicineDetail(BuildContext context, Map<String, dynamic> medicine, String medicineId) {
    int quantity = 1;
                ...
                Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: (medicine['quantity'] ?? 0) > quantity ? () => setState(() => quantity++) : null,
                    ),
                  ],
                ),
                const SizedBox(height: 20),
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text('Added $quantity x ${medicine['name'] ?? 'Unnamed Medicine'} to cart'),
            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                  print('No data or empty for pharmacyId: ${widget.pharmacyId}');
                ...
                return GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: InkWell(
                        onTap: () => _showMedicineDetail(context, medicine, medicine['medicineId']),
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            ClipRRect(
